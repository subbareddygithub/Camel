...
public class SwaggerConfig {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                .info(new Info().title("Mahindra Finance Life Policy").version("v1.0.0")
                        .description("We will try to create policy using Springboot Camunda Workflow.")
    ...
    private Contact getContact() {
        ...
        contact.setEmail("vpankaj@gmail.com");
        contact.setName("Pankaj Varma");
