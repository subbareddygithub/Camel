...
import com.ibm.controller.PolicyController;
...
class PolicyControllerTest {
    ...
    @InjectMocks
    private PolicyController noodlesController;
    ...
    void test_noodles_are_cooked() {
		 ...
		 * noodlesController.cookedNoodles("28242b5c-d524-11eb-878f-dc7196c5d636");
		 * 
		 * Assertions.assertEquals(HttpStatus.OK, responseEntity.getStatusCode());
		 * Assertions.
		 * assertEquals("28242b5c-d524-11eb-878f-dc7196c5d636 is ready to eat.",
    ...
    void test_noodles_are_cooked_but_some_exception() {
		...
		/*
		 * doThrow(NullPointerException.class).when(runtimeService).
		 * createMessageCorrelation(anyString());
		 * 
		 * ResponseEntity<String> responseEntity =
		 * noodlesController.cookedNoodles("28242b5c-d524-11eb-878f-dc7196c5d636");
		 * 
